...
async def generate_dimension_report(dimension: str, score: float, evidence: list[str], llm=None) -> dict:
    ...
    templates = {
        ...
        "social": {
            ...
            "low": {"strengths": "你更偏好独立思考和行动，在需要深度工作和个人空间的任务中能发挥最大价值。", "improve": "不需要强迫自己成为社交达人。重点发展 2-3 个深度关系，同时在工作中利用异步沟通工具（邮件/文档）来协作。"},
        },
        "emotional": {
            ...
            "low_mid": {"strengths": "你对情绪有敏锐的感知能力，这不是弱点——情绪敏感者往往也是高度共情的人。", "improve": "学习区分'我的情绪'和'他人的情绪'，练习在强烈情绪出现时的暂停技巧（如深呼吸 10 次再回应）。"},
            "low": {"strengths": "你的情绪体验丰富而真实，让你在艺术创作和人际共情方面有独特视角。", "improve": "建议从最简单的方法开始——每天 5 分钟的正念呼吸。如果需要，专业心理咨询也是值得考虑的资源。"},
        },
        "drive": {
    ...
    entry = tmpl.get(level, {"strengths": "", "improve": "持续关注这一维度的发展。"})
    return {
